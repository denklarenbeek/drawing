...
exports.updateCronJobActive = exports.updateCronJobDays = exports.updateCronJobTimer = undefined;

var _axios = __webpack_require__(4);

var _axios2 = _interopRequireDefault(_axios);

var _flashes = __webpack_require__(2);

function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }

function updateCronJobTimer(el) {
    if (!el) return;
    var inputField = document.getElementById('cron_jobs_timer');
    inputField.addEventListener('change', function (e) {
        var val = this.value;
        _axios2.default.post('/api/v1/user/timer', { cron_jobs_timer: val }).then(function (res) {
            (0, _flashes.createFlash)(res.data.code, 'Succesfuly change timer for ' + res.data.doc.name);
        }).catch(function (err) {
            (0, _flashes.createFlash)(1, err);
        });
    });
}
...
function updateCronJobDays(el) {
    if (!el) return;
    var inputFields = document.querySelectorAll('.cron-job-day');
    inputFields.forEach(function (el) {
        el.addEventListener('change', function (e) {
            var nameString = this.dataset.day;
            console.log(nameString);
            var cron_job_days = {};
            cron_job_days[nameString] = this.checked;
            _axios2.default.post('/api/v1/user/days', cron_job_days).then(function (res) {
                console.log(res);
                (0, _flashes.createFlash)(res.data.code, 'Succesfuly changed day');
            }).catch(function (err) {
                (0, _flashes.createFlash)(1, err);
            });
        });
...
function updateCronJobActive(el) {
    if (!el) return;
    var inputField = document.querySelector('#cron_jobs');
    inputField.addEventListener('change', function (e) {

        var days = document.querySelector('.job-day');
        var day = document.querySelector('.job-days');
        ...
        if (!val) {
            var inputFields = document.querySelectorAll('.cron-job-day');
            var _inputField = document.querySelector('#cron_job_timer');
            inputFields.forEach(function (el) {
                el.checked = false;
            });
            _inputField.value = 0;
        ...
        _axios2.default.post('/api/v1/user/cronjob', { cron_jobs: val }).then(function (res) {
            console.log(res.data);
            (0, _flashes.createFlash)(res.data.code, 'Succesfully change active job');
        }).catch(function (err) {
            (0, _flashes.createFlash)(1, err);
        });
    });
...
exports.updateCronJobTimer = updateCronJobTimer;
exports.updateCronJobDays = updateCronJobDays;
exports.updateCronJobActive = updateCronJobActive;
...
function addLocationRow(el) {
    ...
    button.addEventListener('click', async function (e) {
        ...
        await _axios2.default.get('/api/v1/products/5b4a8871937047b6d7ff47ec').then(function (res) {
            ...
            var fee = res.data.prices.filter(function (el) {
...
function submitForm(el) {
    ...
    form.addEventListener('submit', function (e) {
        ...
        _axios2.default.post('/api/v1/generate-pcf-contract', {
            ...
            // front end flashes
            (0, _flashes.createFlash)('success', 'contract is created', 10000);
            location.reload();
        }).catch(function (err) {
            console.log(err);
        });
...
async function changeDurationHandler(el) {
    if (!el) return;
    var selectInput = document.getElementById('contract_duration');
    var fees = void 0;
    await _axios2.default.get('/api/v1/products/5b4a8871937047b6d7ff47ec').then(function (res) {
        fees = res.data.prices;
    });
...
exports.showHistoryOpp = undefined;

var _moment = __webpack_require__(0);

var _accounting = __webpack_require__(143);
...
function createPelement(nameOfClass, value, isMoney, isPercentage) {
    if (isMoney) {
        value = _accounting2.default.formatMoney(value, "€", 0, ".", ",");
    }
    if (isPercentage) {
        value = value + "%";
    }
...
function showHistoryOpp(el) {
    if (!el) return;
    var oppContainers = document.querySelectorAll('.opp-container');
    ...
    var _loop = function _loop(i) {
        oppContainers[i].addEventListener('click', function (e) {
            ...
            var id = oppContainers[i].dataset.customid;
    ...
    for (var i = 0; i < oppContainers.length; i++) {
        _loop(i);
    };
}

exports.showHistoryOpp = showHistoryOpp;
...
var _pcf = __webpack_require__(138);

var _loginAnimation = __webpack_require__(137);

var _createPcf = __webpack_require__(136);

var _flashes = __webpack_require__(2);

var _showHistoryOpp = __webpack_require__(140);

var _searchOpp = __webpack_require__(139);

var _changeSettings = __webpack_require__(135);

var _adminSettings = __webpack_require__(134);

var _updateOpp = __webpack_require__(142);
...
(0, _updateOpp.getDefaultValue)(category);
