...
exports.generatePCFContract = async (req, res, next) => {
  ...
  const pdfWriter = hummus.createWriterToModify(new hummus.PDFRStreamForFile( path.join(__dirname, '/templates/pcfcontract.pdf')), new hummus.PDFStreamForResponse(res))
