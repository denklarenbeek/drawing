...
exports.generatePCFContract = async (req, res, next) => {
  ...
  const pdfWriter = hummus.createWriterToModify(new hummus.PDFRStreamForFile(req.headers.host + '/templates/pcfcontract.pdf'), new hummus.PDFStreamForResponse(res))
